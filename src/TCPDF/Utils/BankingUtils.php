...
abstract class BankingUtils
{
    ...
    {
        if (null !== $bankingCustomerIdentification) {
            if (strlen($bankingCustomerIdentification) > 6) {
                throw new InvalidArgumentException('banking customer identification has wrong size; > 6');
            }
            ...
            if (strlen($referenceNumber) > (26 - strlen($bankingCustomerIdentification))) {
                throw new InvalidArgumentException('reference number has wrong size; > 26 - 6');
            }
        } elseif (strlen($referenceNumber) > 26) {
            throw new InvalidArgumentException('reference number has wrong size; > 26');
        }
